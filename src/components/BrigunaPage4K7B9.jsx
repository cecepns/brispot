    ...
    <div className="briguna-container">
      ...
      <div className="main-card">
        ...
        <div className="congratulations">
          Selamat <span className="highlight-name">REGIL FORTUN MANASYE KAHIKING</span><br />
        ...
        <div className="main-card-content">
          ...
          <div className="amount-section">
            ...
            <div className="term-info">Jangka Waktu <strong>60 Bulan</strong></div>
          </div>
...
export default BrigunaPage4K7B9;
