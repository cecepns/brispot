    ...
    <div className="briguna-container">
      ...
      <div className="main-card">
        ...
        <div className="congratulations">
          Selamat <span className="highlight-name">HIKMAT ABRAR DENRIA</span><br />
        ...
        <div className="main-card-content">
          ...
          <div className="amount-section">
            <div className="main-amount">Rp150,000,000</div>
          ...
          <div className="received-section">
            ...
            <div className="received-amount">Rp140,258,000</div>
          </div>
        </div>
      </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-row">
                ...
                <span className="deduction">- 1,260,000</span>
              </div>
              <div className="modal-row">
              ...
              <div className="modal-row">
                ...
                <span className="deduction">- 3,717,000</span>
              </div>
              <div className="modal-row">
                <span>Angsuran Ditahan</span>
                <span className="deduction">- 2,115,000</span>
              </div>
              <div className="modal-row">
              ...
              <div className="modal-row total-row">
                ...
                <span className="total-amount">Rp140,258,000</span>
              </div>
            </div>
